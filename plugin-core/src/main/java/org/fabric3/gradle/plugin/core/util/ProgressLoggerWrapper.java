 ...
 * @author Patrick Boos (adjustments for fabric3)
 */
public class ProgressLoggerWrapper {
     ...
     */
    public ProgressLoggerWrapper(Project project, String loggerCategory)
            throws ClassNotFoundException, NoSuchMethodException,
            InvocationTargetException, IllegalAccessException {
        this(project, loggerCategory, null);
    }
     ...
     *                                   internal classes is not accessible
     */
    public ProgressLoggerWrapper(Project project, Class<?> loggerCategory)
            throws ClassNotFoundException, NoSuchMethodException,
            InvocationTargetException, IllegalAccessException {
        this(project, null, loggerCategory);
    }

    private ProgressLoggerWrapper(Project project, String loggerCategoryString, Class<?> loggerCategoryClass)
            throws ClassNotFoundException, NoSuchMethodException,
            InvocationTargetException, IllegalAccessException {
        ...
        if (loggerCategoryString != null) {
            progressLogger = invoke(progressLoggerFactory, "newOperation", loggerCategoryString);
        } else if (loggerCategoryClass != null) {
            progressLogger = invoke(progressLoggerFactory, "newOperation", loggerCategoryClass);
        } else {
    ...
    public void setDescription(String description) {
        invokeIgnoreExceptions(progressLogger, "setDescription", description);
    }

    public void setLoggingHeader(String header) {
        invokeIgnoreExceptions(progressLogger, "setLoggingHeader", header);
    }
